...
2. **Create a New C# Console App:**
   ...
   ```text
   /new Create a C# console application with project name as MusicStore.csproj and a solution file as MusicStore.sln, outputs an executable file. Use TargetFramework as net8.0.
   ```
